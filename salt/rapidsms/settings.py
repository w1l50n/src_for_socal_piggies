# Django settings for rapidsms_pi project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a rapidsms_pi directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'rapidsms_pi')
...
DATABASES = {
    'default': {
        ...
        'USER': 'rapidsms',
        'PASSWORD': 'rapidsms',
        'HOST': '', # don't specify host and port to connect through a local socket
        'PORT': '',
    }
}
...
ROOT_URLCONF = 'rapidsms_pi.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'rapidsms_pi.wsgi.application'
...
INSTALLED_BACKENDS = {
    ...
    "kannel-gsm-modem" : {
        ...
        "sendsms_params": {"smsc": "gsm-modem-0",
        ...
        "delivery_report_url": "http://127.0.0.1",
    },
}
...
RAPIDSMS_HANDLERS = (
    'sms_raffle.handlers.RaffleHandler',
    'sms_raffle.handlers.RaffleResultHandler',
    'pi_cam.handlers.TweetHandler',
